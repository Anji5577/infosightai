...
export function SplineSceneBasic() {
  return (
    <div className="hero-card w-full h-[600px] md:h-[650px] relative overflow-hidden">
      <Spotlight
      ...
      <div className="flex h-full flex-col md:flex-row">
        {/* Left content */}
        <div className="flex-1 p-8 md:py-8 md:px-12 relative z-10 flex flex-col justify-start text-left">
